...
export default function layout() {
  ...
  const cardPantipPick: CardData[] = [
    ...
    },
    {
      id: 4,
      title:
        "เบคอน -สันคอหมูสไลด์ ผัดเทอริยากิ ใส่ไข่, เต้าหูดอยทอด กับแกงส้มใส่เบคอน-เต้าหู้อ่อน ใส่ไข่🥚🐣✌️🤤😋😁🥢🥣อาหารพื้นบ้านวัตถุดิบทำอาหารอาหารคลีนทำอาหารเคล็ดลับก้นครัว",
